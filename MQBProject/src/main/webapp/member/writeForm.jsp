...
<form name="writeForm" id="writeForm" method="post" >
	<table border="1" cellspacing="0" cellpadding="5">
		...
		<tr>
			...
			<td>
				<input type="text" name="id" id="id" placeholder="아이디 입력">  <!-- onclick="location.href='/mvcmember/member/checkId.do'" -->
			<!-- 이 버튼 없애고 바로 아이디 입력하며 ㄴ중복확인되게 하려고 없앰.	<input type="button" value="중복체크" id="checkIdBtn"> -->
				<input type="hidden" id="check" value="">  <!-- 히든으로 잡아서 안보이는데 텍스트로 바꾸면 보임. 벨류 아무것도 안준것 아이디의 값을 넣을것? -->
		...
		<tr>
			<td colspan="2" align="center">
				<input type="button" id="writeBtn" value="회원가입"> <!-- 버튼이 역할 해주니깐 온클릭 필요 없음  -->
